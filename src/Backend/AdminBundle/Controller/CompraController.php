...
class CompraController extends Controller
{
     ...
     public function generateSQL($search,$model){
		...
		if($model){
		  ...
		  $dql="SELECT u FROM BackendAdminBundle:Articulo u INNER JOIN u.modelos p where p.id = $model and u.isDelete=false and u.isDisponible=true" ;	   
    ...
    /**
     * Lists all Articulo entities and Model.
     *
     */
    public function indexAction(Request $request,$search,$model)
    {
       if ( $this->get('security.context')->isGranted('ROLE_VIEWARTICULO')) {
        ...
        return $this->render('BackendAdminBundle:Compra:index.html.twig', 
